...
<body>
	...
	<div class="container" id="main">
		...
		<form action="${webContent}createArticle.action" method="post"
			...
			<div class="info">
				...
				<span class="help">时间</span> <input type="text" class="form-control"
					id="time1" name="time" value="${time}" readonly="readonly" />
				<!-- author-->
				<span class="help">作者</span> <input type="text" class="form-control"
					id="user1" name="author" value="${USER_SESSION.username}"
					readonly="readonly" />
				<!-- sort -->
				...
				<input type="text" class="form-control" id="tags1" name="tags">
			</div>
