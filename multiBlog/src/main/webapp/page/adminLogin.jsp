...
<div class="container">
	<div id="center_content">
    	<h1 >
        	<a href="" style="color: #337ab7;font-weight:normal;">AdminLogin</a>
        </h1><br/>
        <font color="red">
			 <%-- 提示信息--%>
        ...
        <div id="form">
    		...
    		<input type="text" name="username" class="form-control " placeholder="用户名"/><br/>			       	  		<input type="password" name="password" class="form-control" placeholder="密码"/><br/>
           		<!--&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;-->          
...
<div id="footer">
		<a href="" style="color: #337ab7;font-weight:normal;"> <img
