...
<link type="text/css" rel="stylesheet" href="${webContent }css/tags.css" />
<style>
*{
	margin:0;
	padding:0;
		...
		<div id="left_content"> 
			...
			<div class="col-md-7 " id="right_content">
				...
				<div class="list-group">
					...
					<div class="tags_name">
					<!-- 标签名字 -->
					<%-- <span class="glyphicon glyphicon-triangle-bottom"></span>&nbsp;	&nbsp;${map.key.tag} --%>
					<%-- ${map.key.tag} 是否加.tag 看map中key是不是 复合型数组 还是单纯的tag数组，单纯的tag数组就.key就行了 --%>					
					...
					<li class="list-group-item">
								<div>
									<div>
									<div>
										<a href="./Article.action?id=${list.article_id}">${list.title}</a>
									</div>
									<div class="c_right">									
